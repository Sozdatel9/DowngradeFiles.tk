...
<TEXTAREA name='' cols=80 rows=3>&lt;a href=&quot;<?php echo "" .$scripturl. "download.php?file=" . $filecrc . "";?>&quot; title=&quot;Скачать файл <?php echo $imya_fayla;?>&quot; alt=&quot;Скачать файл <?php echo $imya_fayla;?>&quot; &gt;Скачать файл <?php echo $imya_fayla;?>&lt;/a&gt;</TEXTAREA>
...
<P><B><A HREF=<?php echo "\"" .$scripturl. "showqr.php?file=" . $filecrc . "\"";?> TARGET="_blank">QR-код (ссылка откроется в новой вкладке или новом окне)</A></B></P>
<B>BB-код ссылки для форумов:</B>
<BR><TEXTAREA name='' cols=80 rows=3>[URL=<?php echo "" .$scripturl. "download.php?file=" . $filecrc . "";?>]Скачать файл <?php echo $imya_fayla;?>[/URL]</TEXTAREA></TD></TR>