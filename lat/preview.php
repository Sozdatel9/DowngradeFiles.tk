...
{
if ($filesize > 1) {
        echo "<TR><TD VALIGN=TOP COLSPAN=14><CENTER><FONT SIZE='+1' COLOR=#FCFE54>Predvaritelnyi prosmotr</FONT></CENTER><BR><CENTER>Predvaritelnyi prosmotr nedostupen, poskol'ku kartinka slishkom bolshaya</CENTER></TD></TR>";
	}
else {
        echo "<TR><TD VALIGN=TOP COLSPAN=14><CENTER><FONT SIZE='+1' COLOR=#FCFE54>Predvaritelnyi prosmotr</FONT></CENTER><BR><CENTER><IMG TITLE='".$imya_fayla."' ALT='".$imya_fayla."' SRC=\"" .$scripturl. "download2.php?a=" . $filecrc . "&b=" . md5($foundfile[2].$_SERVER['REMOTE_ADDR']) . "&preview=on\" WIDTH=\"400px\"></CENTER></TD></TR>";	 
	 }
}
