...
if ($filesize > 1) {
        ...
        echo "<tr><td valign=top colspan=14><center><font size='+1' color=#FCFE54>Predvaritelnyi prosmotr</font></center><br><center><img title='".$imya_fayla."' alt='".$imya_fayla."' src=\"" .$scripturl. "download2.php?a=" . $filecrc . "&b=" . md5($foundfile[2].$_SERVER['REMOTE_ADDR']) . "\" width=\"400px\"></center></td></tr>";	 
	 }
}
