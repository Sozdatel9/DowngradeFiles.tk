...
/*Ïğåîáğàçóåì êğàòêèå îáîçíà÷åíèÿ òèïîâ ôàéëîâ â ïîíÿòíûé âèä*/
...
else {echo"<center><font color=\"#FCFE54\" size=\"+2\"> <B>Vse Fayly</B> </font></center>";}/*<!--Ñïèñîê çàãğóæåííûõ ôàéëîâ-->*/?>
...
$maxpagesize=$maxfilesonpage; //êîëè÷åñòâî ôàéëîâ íà îäíîé ñòğàíèöå
...
//âûâîäèì ìàññèâ ñî ñïèñêîì ôàéëîâ â îáğàòíîì ïîğÿäêå
//íåäàâíî çàãğóæåííûå ôàéëû - ñâåğõó
...
/*Óáèğàåì ëèøíèå ñèìâîëû èç èìåíè ôàéëà*/
...
echo "<TD>".date('Y-m-d G:i', $thisline[4])."</TD>
  ...
  $tempstring1 = strtr( $thisline[1], 'ÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸abcdefghijklmnopqrstuvwxyz' );

  $tempstring2 = strtr( $thisline[6], 'ÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸abcdefghijklmnopqrstuvwxyz' );

  $tempstring3 = strtr( $keyword1, 'ÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸abcdefghijklmnopqrstuvwxyz' );
...
/*Åñëè âêëş÷åí ğåæèì îòîáğàæåíèÿ ôàéëîâ, òî...*/
//*********************************
 $filesononepage++;
 $imya_fayla=htmlspecialchars($thisline[1], ENT_QUOTES);
...
echo "</SELECT>";
echo "<INPUT TYPE=\"submit\" value=\"ÎÊ\">";
echo "</FORM>";
echo "</TD>";
echo "</TR>";
echo "<TR>";
...
for ($i=0; $i<$totalpages; $i++) {
  ...
  else { echo "	  <A HREF=\"files.php?p=".$pg1."\" ALT=\"Pereyti na ".$pg1." stranicu\" TITLE=\"Pereyti íà ".$pg1." stranicu\" >".($pg1)."</A>&nbsp;&nbsp;"; }
}
echo "</TD></TR><TR><TD COLSPAN=2 ALIGN=CENTER>&nbsp;&nbsp;</TD></TR></TABLE>";
}
else{echo "<TD COLSPAN=14> <br /> <CENTER> Nichego ne naydeno! </CENTER>";}
echo "</TD> </TR>";  
/*Áëîê ïîñòğàíè÷íîé íàâèãàöèè*/
